...
<c:forEach items="${aeprojects}" var="item">
	<tr class="rowTr">
	    <td>${item.id}</td>
		...
		<td>
			<a class="btn btn-link btn-edit" href="javascript:location.href='${ctx}/aeprojectController/toedit.do?id=${item.id}';">修改</a>
			<a class="btn btn-link btn-delete" href="javascript:;" onclick="deleteaeproject('${item.id}')">删除</a>
		</td>
	</tr>
