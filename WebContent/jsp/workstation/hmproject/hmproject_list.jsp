...
<html lang="en">
	...
	<body>
						...
						<div class="span4">
							<div class="control-group control-group-m">
								<div class="controls controls-l">
									<button class="btn btn-small btn-success btn-add" onclick="javascript:location.href='${ctx}/hmprojectController/toadd.do';">
		...
		<script type="text/javascript">					
			var ctx = "${ctx}";
			var controller = "/hmprojectController";
			var sumrow;
			var currentpage;
		</script>
