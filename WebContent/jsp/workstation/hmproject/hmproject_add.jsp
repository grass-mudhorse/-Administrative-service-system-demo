		...
		<div class="main-container container-fluid">
			<div class="main-content">
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/hmprojectController/add.do" method="post">
						...
						<div class="row-fluid">
							...
							<div class="span5">
								<div class="control-group control-group-m">
									<label class="control-label control-label-l">账户</label>
						...
						<div class="row-fluid">
							...
							<div class="span5">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" readonly= "readonly" name="projectloiid"/>
									</div>
								</div>	
							</div><!--/span-->
							...
							<div class="span5">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" readonly= "readonly" name="feasibilityreportid"/>
									</div>
								</div>	
							</div><!--/span-->
				...
				<div></div>
					<div class="span5">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" readonly= "readonly" name="offerlistid"/>
									</div>
								</div>	
					</div><!--/span-->
							...
							<div class="span5">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" readonly= "readonly" name="contractid"/>
									</div>
								</div>	
							</div><!--/span-->
				...
				<div></div>
					...
					<div class="span5">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" readonly= "readonly" name="project"/>
									</div>
								</div>	
					</div><!--/span-->
			...
			<div></div>
				<div class="span5">		
						<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<select class="chzn-select" data-placeholder="-请选择-" name="flag"   
										>											
