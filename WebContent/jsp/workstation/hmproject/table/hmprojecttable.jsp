...
<c:forEach items="${hmprojects}" var="item">
	<tr class="rowTr">
	    <td>${item.id}</td>
		...
		<td>
			...
			<a class="btn btn-link btn-edit" href="javascript:location.href='${ctx}/hmprojectController/toedit.do?id=${item.id}';">修改</a>
			<a class="btn btn-link btn-delete" href="javascript:;" onclick="deletehmproject('${item.id}')">删除</a>
		</td>
	</tr>
