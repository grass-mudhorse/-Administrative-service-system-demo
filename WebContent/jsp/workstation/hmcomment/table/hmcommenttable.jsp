...
<c:forEach items="${hmcomments}" var="item">
	<tr class="rowTr">
		...
		<td>
			<a class="btn btn-link btn-edit" href="javascript:location.href='${ctx}/hmcommentController/toedit.do?id=${item.id}';">修改与查看</a>
			<a class="btn btn-link btn-delete" href="javascript:;" onclick="deletehmcomment('${item.id}')">删除</a>
		</td>
	</tr>
</c:forEach>
