		...
		<div class="main-container container-fluid">
			<div class="main-content">
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/aefileController/edit.do" method="post">
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="category"  readonly="readonly" value="${aefile.category}"/>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="createid"  value="${aefile.createrid}"/>
									</div>
								</div>		
							</div><!--/span-->
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="projectid"   value="${aefile.projectid}"/>
									</div>
								</div>		
							</div><!--/span-->
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="filecheck"   value="${aefile.filecheck}"/>
									</div>
								</div>		
							</div><!--/span-->
							</div><!--/.row-fluid-->
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="date"   value="${aefile.date}"/>
									</div>
								</div>		
							</div><!--/span-->
