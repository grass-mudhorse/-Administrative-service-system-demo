		...
		<div class="main-container container-fluid">
			<div class="main-content">
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/pmfileController/download.do" method="post">
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="class" readonly="readonly" value="${pmfile.category}"/>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="createid" readonly="readonly" value="${pmfile.createrid}"/>
									</div>
								</div>		
							</div><!--/span-->
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="projectid"  readonly="readonly" value="${pmfile.projectid}"/>
									</div>
								</div>		
							</div><!--/span-->
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="date"  readonly="readonly" value="${pmfile.date}"/>
									</div>
								</div>		
							</div><!--/span-->
							</div><!--/.row-fluid-->
