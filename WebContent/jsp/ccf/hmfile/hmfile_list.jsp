...
<html lang="en">
	...
	<body>
						...
						<div class="span4">
							<div class="control-group control-group-m">
								<div class="controls controls-l">
									<button class="btn btn-small btn-success btn-add" onclick="javascript:location.href='${ctx}/hmfileController/toadd.do';">
		...
		<script type="text/javascript">					
			var ctx = "${ctx}";
			var controller = "/hmfileController";
			var sumrow;
			var currentpage;
		</script>
