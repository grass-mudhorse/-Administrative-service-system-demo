		...
		<div class="main-container container-fluid">
			<div class="main-content">
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/pefileController/download.do" method="post">
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="class" readonly="readonly" value="${pefile.category}"/>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="createid" readonly="readonly" value="${pefile.createrid}"/>
									</div>
								</div>		
							</div><!--/span-->
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="projectid"  readonly="readonly" value="${pefile.projectid}"/>
									</div>
								</div>		
							</div><!--/span-->
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="date"  readonly="readonly" value="${pefile.date}"/>
									</div>
								</div>		
							</div><!--/span-->
							</div><!--/.row-fluid-->
