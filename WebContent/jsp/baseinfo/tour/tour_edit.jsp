		...
		<div class="main-container container-fluid">
			<div class="main-content">
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/tourController/edit.do" method="post">
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="tourname" value="${tour.tourname}"/>
									</div>
								</div>	
							</div><!--/span-->
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="tourage" value="${tour.tourage}"/>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="toursex" value="${tour.toursex}"/>
									</div>
								</div>		
							</div><!--/span-->
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="tourphone" value="${tour.tourphone}"/>
									</div>
								</div>		
							</div><!--/span-->
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="tourcon" value="${tour.tourcon}"/>
									</div>
								</div>		
							</div><!--/span-->
				<div class="span4">		
