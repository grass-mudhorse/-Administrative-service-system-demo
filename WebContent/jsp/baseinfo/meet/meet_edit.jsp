		...
		<div class="main-container container-fluid">
			<div class="main-content">
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/meetController/edit.do" method="post">
						...
						<div class="row-fluid">
							...
							<div class="span5">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="meetname" value="${meet.meetname}"/>
									</div>
								</div>	
							</div><!--/span-->
							...
							<div class="span5">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="meetsize" value="${meet.meetsize}"/>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid">
							...
							<div class="span5">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="meetloc" value="${meet.meetloc}"/>
									</div>
								</div>		
							</div><!--/span-->
							...
							<div class="span5">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="meetpri" value="${meet.meetpri}"/>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
							...
							<div class="span5">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-l">
										<input type="text" name="meetcon" value="${meet.meetcon}"/>
									</div>
								</div>		
							</div><!--/span-->
