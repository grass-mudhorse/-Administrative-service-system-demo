		...
		<div class="main-container container-fluid">
			<div class="main-content">
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/carController/edit.do" method="post">
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="carcol" value="${car.carcol}"/>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="cartime" value="${car.cartime}"/>
									</div>
								</div>		
							</div><!--/span-->
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="carpri" value="${car.carpri}"/>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="carcon" value="${car.carcon}"/>
									</div>
								</div>		
							</div><!--/span-->
					<div class="span4">		
						<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<select class="chzn-select" data-placeholder="-请选择-" name="cartempcon" value="${car.cartempcon}">											
