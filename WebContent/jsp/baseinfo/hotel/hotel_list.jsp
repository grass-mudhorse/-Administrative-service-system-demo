	...
	<body>
		<div class="main-container container-fluid">			
			...
			<div class="main-content">
						...
						<div class="span4">
							<div class="control-group control-group-m">
								<div class="controls controls-l">
									<button class="btn btn-small btn-success btn-add" onclick="javascript:location.href='${ctx}/hotelController/toadd.do';">
										<i class="icon-share-alt"></i>
										新增
									</button>
									<button class="btn btn-small btn-success btn-add" onclick="javascript:location.href='${ctx}/hotelController/export.do';">
										<i class="icon-share-alt"></i>
										导出
									</button>
								</div>
				...
				<form method="POST"  enctype="multipart/form-data" id="form1" action="${ctx}/hotelController/impotr.do">
