		...
		<div class="main-container container-fluid">
			<div class="main-content">
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/giftController/edit.do" method="post">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="giftkind" value="${gift.giftkind}"/>
									</div>
								</div>	
							</div><!--/span-->
						...
						<div class="row-fluid">
						  ...
						  <div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="giftbudget" value="${gift.giftbudget}"/>
									</div>
								</div>		
							</div><!--/span-->
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="giftpri" value="${gift.giftpri}"/>
									</div>
								</div>		
							</div><!--/span-->
					...
					<div class="span4">		
						<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<select class="chzn-select" data-placeholder="-请选择-" name="gifttempcon" value="${gift.gifttempcon}">											
