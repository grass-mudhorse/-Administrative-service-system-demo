				...
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/employeeController/edit.do" method="post" enctype="multipart/form-data">
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									<label class="control-label control-label-m">员工ID</label>
							...
							<div class="span4">	
								<div class="control-group control-group-m">
									<label class="control-label control-label-m">小组编号</label>
									<div class="controls controls-m">
										<input type="text" name="jobtitleid" value="${employee.jobtitleid}"/>
									</div>
								</div>
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									<label class="control-label control-label-m">员工姓名</label>
									<div class="controls controls-m">
					...
					<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									<label class="control-label control-label-m">职务</label>
									<div class="controls controls-m">
										<select id="position" class="chzn-select" data-placeholder="-请选择-" name="positionid" >
											<option value="1" />业务员
											<option value="2" />业务经理
											<option value="3" />项目经理
											<option value="4" />业务负责人
											<option value="5" />总经理
											<option value="6" />项目人员
										</select>
									</div>
